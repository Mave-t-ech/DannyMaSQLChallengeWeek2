...
![Screenshot (211)](https://github.com/Mave-t-ech/DannyMaSQLChallengeWeek2/assets/111718556/a7f74760-7384-4152-bb98-0e8c58ae57ea)
...
First I altered the table to change the column I wanted to work in.
```
...
Group by runner_id;
```
Then I changed the column back to what it was and I solved the question WITHout altering the table
```
ALTER TABLE runner_orders
